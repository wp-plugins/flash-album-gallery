<?php
/*
Skin Name: Midnight International Skin
Skin URI: 
Description: Default International Skin for Flash Album Gallery. You can use any language you want for album name, alt/title and description in FlAGallery  ;)
Author: PGC
