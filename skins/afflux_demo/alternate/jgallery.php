...
<script type="text/javascript" src="<?php echo $flag_options['skinsDirURL'].$skin; ?>/alternate/scripts/jquery.mousewheel.js"></script>
...
.afflux .flagcatlinks { padding: 12px 10px; margin:0 0 3px; background: #000000; }
.afflux .flagcatlinks a.flagcat { padding: 0px 10px; margin: 0; border: none; border-left: 1px dotted #75c30f; font: 14px Tahoma; text-decoration: none; background: none; color: #75c30f; }
...
.afflux .flagcategory { width: 100%; height: auto; position: relative; text-align: center; padding-bottom:1px; }
.afflux .flagcategory a { display: inline-block; margin: 1px 0 0 1px; padding: 0; height: 100px; width: 115px; line-height: 96px; position:relative; overflow: hidden; text-align: center; z-index:99; cursor:pointer; background-color: #ffffff; border: 2px solid #ffffff; text-decoration: none; background-repeat: no-repeat; background-position: 50% 50%; font-size: 8px; }
.afflux .flagcategory a:hover { background: #ffffff; border: 2px solid #ffffff; text-decoration: none; }
.afflux .flagcategory a img { vertical-align: middle; display:inline-block; position: static; margin: 0 auto; padding: 0; border: none; max-height: 100px; max-width: 115px; }

.afflux { background-color: <?php echo $bg; ?>; visibility: hidden; }
.afflux .flagcatlinks { background-color: #<?php echo $BarsBG; ?>; }
.afflux .flagcatlinks a.flagcat { border-color: #<?php echo $CatColor; ?>; color: #<?php echo $CatColor; ?>; }
.afflux .flagcatlinks a.flagcat:hover { border-color: #<?php echo $CatColor; ?>; }
.afflux .flagcatlinks a.active, .afflux .flagcatlinks a.flagcat:hover { color: #<?php echo $CatColorOver; ?>; }
.afflux .flagcategory { background-color: <?php echo $bgBar; ?>; }
.afflux .flagcategory a { background-color: #<?php echo $ThumbBG; ?>; border: 2px solid #<?php echo $ThumbBG; ?>; background-image: url(<?php echo $flag_options['skinsDirURL'].$skin; ?>/alternate/scripts/images/loadingAnimation.gif); color: #<?php echo $ThumbBG; ?>; }
.afflux .flagcategory a:hover { background-color: #<?php echo $ThumbBG; ?>; border: 2px solid #<?php echo $ThumbBG; ?>; }
...
?>
	<?php if (is_array ($thepictures) && count($thepictures)){ ?>
		...
		<div class="flagcategory horizontal-only" id="gid_<?php echo $galID; ?>">
